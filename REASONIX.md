...
agent. It is the LGcode analog of Claude Code's CLAUDE.md.
...
- Hierarchical docs: `LGCODE.md` (this file, committed/shared), `LGCODE.local.md`
  (personal, git-ignored), user-global `~/.config/reasonix/LGCODE.md`, and any
  `LGCODE.md` in an ancestor dir. `AGENTS.md` is accepted as a fallback name.
