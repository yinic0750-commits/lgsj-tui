...
<header><a class="brand" href="https://lgcode.io">${LOGO}</a><a class="brand" href="https://lgcode.io">LGcode</a><span class="crumb">/ ${esc(crumb)}</span>${LANG_SWITCH}${nav ? `<span class="nav">${nav}</span>` : ""}</header>
