...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — LGcode end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "lgcode", "path to the lgcode binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 LGcode e2e benchmark\n\n")
