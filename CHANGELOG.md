...
All notable changes to the Go line (LGcode 1.0+) are recorded here. The legacy
`0.x` TypeScript history lives on the [`v1`](https://github.com/esengine/DeepSeek-LGcode/tree/v1)
branch.
...
- **Memory**: `LGCODE.md` hierarchy + auto-memory, folded into the cache-stable
  prefix.
...
[1.0.0]: https://github.com/esengine/DeepSeek-LGcode/releases/tag/v1.0.0
