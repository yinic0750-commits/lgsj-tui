...
// workspace root is the lgcode user config directory.
...
func desktopConfigDir() string {
	...
	if err != nil {
		...
		return filepath.Join(home, ".lgcode")
	}
...
func topicTitlesPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".lgcode", topicTitlesFile)
}
...
func topicTitleSourcesPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".lgcode", topicTitleSourcesFile)
}
...
func topicCreatedAtsPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".lgcode", topicCreatedAtsFile)
}
...
func globalWorkspaceRoot() string {
	...
	if err != nil {
		home, _ := os.UserHomeDir()
		return filepath.Join(home, ".lgcode", "global-workspace")
	}
	return filepath.Join(dir, "lgcode", "global-workspace")
}
