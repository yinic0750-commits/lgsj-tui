// Command lgcode-desktop is the Wails shell around the LGcode kernel: a native
...
// a nested module (lgcode/desktop) so the CGO/WebKit desktop build never touches
...
import (
	...
	// cmd/lgcode does — boot.Build resolves providers/tools from these registries.
...
// mirroring cmd/lgcode/main.go. The auto-updater reads it (App.Version) to compare
...
const disableWebview2GPUEnv = "LGCODE_DESKTOP_DISABLE_WEBVIEW2_GPU"
...
func main() {
	...
	err := wails.Run(&options.App{
		...
		BackgroundColour:   &options.RGBA{R: 9, G: 16, B: 11, A: 255},
