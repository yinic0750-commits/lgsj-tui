...
const DM = "__LGCODE_MATH_DISPLAY__";
const IM = "__LGCODE_MATH_INLINE__";
const LB = "__LGCODE_LATEX_LINEBREAK__";
const ED_BASE = "LGCODEESCAPEDDOLLAR";
const DOLLAR = "&#36;";
...
function unusedPlaceholderPrefix(s: string): string {
  let prefix = "__LGCODE_PROTECTED_CODE__";
  let n = 0;
  while (s.includes(prefix)) {
    n += 1;
    prefix = `__LGCODE_PROTECTED_CODE_${n}__`;
  }
  return prefix;
}
