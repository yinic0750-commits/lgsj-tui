...
export const en = {
  ...
  "sidebar.navigation": "LGcode navigation",
  ...
  "caps.updateManagedByNpx": "Managed by npx/npm; LGcode does not pin this runtime",
  "caps.updateManagedByNpxShort": "Updates via npx",
  "caps.updateBundledWithApp": "Updated with the LGcode app",
  ...
  // composer
  "composer.placeholder": "Message LGcode…  ( / commands · @ files · ! shell )",
  ...
  "memory.noDocs": "No LGCODE.md found. Quick-add one above.",
  ...
  "memory.emptySavedBody": "Save durable background only when it should help future LGcode sessions in this project.",
  ...
  "settings.closeBehavior.quit": "Quit LGcode",
  ...
  "settings.agentRuntimeHint": "Used as global defaults; ./lgcode.toml can override them per project. 0 means unlimited.",
  ...
  "settings.botInstallSubtitle": "Once connected, LGcode can be used from chat.",
  ...
  "settings.pageDesc.memory": "Manage preferences, project conventions, and instruction files LGcode keeps referencing.",
  ...
  "settings.addProvider.officialChoiceHint": "Choose from LGcode presets for DeepSeek and Mimo.",
  ...
  "settings.hooksPathProjectHint": "Project hooks are saved to .lgcode/settings.json in the current workspace.",
  ...
  "settings.hooksGlobalHint": "Saved globally. Restart LGcode to load new hooks.",
  "settings.hooksProjectHint": "Saved in this workspace. Project hooks load after trust and a LGcode restart.",
  ...
  "updater.autoCheckHint": "When off, LGcode won't check automatically when it opens. You can still check manually here.",
  ...
  "onboarding.title": "Connect LGcode",
  ...
  // crash page
  "crash.title": "LGcode hit an error — send us the report, or copy it",
  "crash.copy": "Copy",
  ...
  "performanceReport.title": "LGcode noticed a responsiveness issue",
  ...
  "mock.askQ2Header": "LGcode build",
  "mock.askQ2Prompt": "What do you want to do about the missing lgcode binary?",
  ...
  "mock.changedFile2Path": ".lgcode/project.md",
};
