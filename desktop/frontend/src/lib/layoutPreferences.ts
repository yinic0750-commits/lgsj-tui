...
const STORAGE_KEY = "lgcode.layoutPreferences.v1";

const LEGACY_SIZE_KEYS: Record<LayoutSizeKey, string[]> = {
  sidebarWidth: ["lgcode.sidebar.width"],
  sidebarWidthGraphite: [],
  rightDockWidth: [],
  rightDockTreeWidth: [],
  rightDockPreviewWidth: [],
  workspaceFileTreePanelWidth: [],
  workspaceTreeWidth: ["lgcode.workspaceTree.width"],
  composerHeight: ["lgcode.composerHeight"],
  drawerWidth: ["lgcode.drawer.width"],
  settingsDrawerWidth: ["lgcode.settingsDrawer.width"],
};
