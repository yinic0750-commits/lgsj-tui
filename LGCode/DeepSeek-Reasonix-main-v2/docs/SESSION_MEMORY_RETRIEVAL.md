...
- Keep LGcode cache-first: stable prompt bytes stay stable across turns, while
...
LGcode treats saved memory as a synthesis cache rather than as a raw transcript
cache.
