...
func (a *App) startTray() {
	...
	t.end = startDesktopTray(func() {
		...
		systray.SetTitle("LGcode")
		systray.SetTooltip("LGcode")
...
func trayMenuLabels(locale string) trayLabels {
	if locale == "zh" {
		return trayLabels{
			openTitle:   "打开",
			openTooltip: "打开 LGcode 窗口",
			quitTitle:   "退出",
			quitTooltip: "退出 LGcode",
		}
	}
	return trayLabels{
		openTitle:   "Open",
		openTooltip: "Open the LGcode window",
		quitTitle:   "Quit",
		quitTooltip: "Quit LGcode",
	}
}
