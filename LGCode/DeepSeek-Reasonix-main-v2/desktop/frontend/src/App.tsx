...
const SIDEBAR_COLLAPSED_KEY = "lgcode.sidebar.collapsed";
...
function sessionItemsToMarkdown(title: string, items: Item[], live?: LiveStream): string {
  const lines: string[] = [`# ${title.trim() || "LGcode session"}`, ""];
          ...
          {sidebarWorkbench ? (
            <>
              <div className="sidebar__head" aria-hidden={sidebarCollapsed}>
                <div className="sidebar__brand sidebar__brand--workbench">
                  <img src={logoWordmark} alt="LGcode" className="sidebar__brand-logo sidebar__brand-logo--workbench" draggable={false} />
                </div>
              </div>
            ...
            <>
              <div className="sidebar__brand" aria-hidden={sidebarCollapsed}>
                <img src={logoWordmark} alt="LGcode" className="sidebar__brand-logo" draggable={false} />
              </div>
