...
export const zh: Record<DictKey, string> = {
  ...
  "caps.updateManagedByNpx": "由 npx/npm 管理，LGcode 不托管固定版本",
  "caps.updateManagedByNpxShort": "由 npx 管理更新",
  "caps.updateBundledWithApp": "随 LGcode 应用本体更新",
  ...
  // 输入框
  "composer.placeholder": "给 LGcode 发消息…  ( / 命令 · @ 文件 · ! 终端 )",
  ...
  "memory.noDocs": "未找到 LGCODE.md。可在上方快速添加一条。",
  ...
  "memory.emptySavedBody": "只保存对后续 LGcode 会话有帮助的长期背景。",
  ...
  "settings.closeBehavior.quit": "退出 LGcode",
  ...
  "settings.agentRuntimeHint": "作为全局默认；项目里的 ./lgcode.toml 可覆盖。0 表示不限。",
  ...
  "settings.botInstallSubtitle": "连接完成后即可在聊天里调用 LGcode。",
  ...
  "settings.pageDesc.memory": "管理 LGcode 会长期参考的偏好、项目约定和指令文件。",
  ...
  "settings.addProvider.officialChoiceHint": "从 LGcode 预设的 DeepSeek 与 Mimo 接入中选择。",
  ...
  "settings.hooksPathProjectHint": "项目 hooks 保存到当前工作区的 .lgcode/settings.json。",
  ...
  "settings.hooksGlobalHint": "保存为全局配置。重启 LGcode 后加载新的 hooks。",
  "settings.hooksProjectHint": "保存在当前工作区。项目 hooks 需要信任，并在重启 LGcode 后加载。",
  ...
  "updater.autoCheckHint": "关闭后，LGcode 打开时不会自动检查更新；你仍可在此页手动检查。",
  ...
  // 崩溃兜底页
  "crash.title": "LGcode 遇到错误 —— 可以一键发送报告，或复制后反馈",
  "crash.copy": "复制",
  "crash.send": "发送报告",
  "crash.sending": "发送中…",
  "crash.sent": "已发送，谢谢！",
  ...
  "performanceReport.title": "LGcode 检测到响应卡顿",
  ...
  "mock.askQ2Header": "LGcode 构建",
  "mock.askQ2Prompt": "对于 lgcode 二进制缺失的问题，你想怎么做？",
