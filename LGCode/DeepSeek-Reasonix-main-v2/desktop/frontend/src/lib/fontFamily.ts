...
const FONT_FAMILY_KEY = "lgcode-font-family";
const CUSTOM_FONT_KEY = "lgcode-font-family-custom";
const MONO_FONT_FAMILY_KEY = "lgcode-mono-font-family";
const CUSTOM_MONO_FONT_KEY = "lgcode-mono-font-family-custom";
