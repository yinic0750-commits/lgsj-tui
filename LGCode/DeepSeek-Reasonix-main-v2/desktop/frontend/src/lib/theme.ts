...
const THEME_KEY = "lgcode-theme";
const STYLE_KEY = "lgcode-theme-style";
...
function syncNativeWindowBackground(theme: Theme): void {
  ...
  if (resolved === "light") {
    // Light shell: warm off-white.
    WindowSetBackgroundColour(248, 247, 244, 255);
  } else {
    // Dark shell: green-tinged black (#090f0c).
    WindowSetBackgroundColour(9, 15, 12, 255);
  }
}
