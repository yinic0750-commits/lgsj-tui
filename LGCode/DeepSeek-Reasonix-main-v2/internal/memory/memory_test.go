...
func TestComposeAppendsAfterBase(t *testing.T) {
	base := "BASE PROMPT"
	set := &Set{Docs: []Source{{Path: "/p/LGCODE.md", Scope: ScopeProject, Body: "Use tabs."}}}
	got := Compose(base, set)
...
func TestDiscoverPrecedenceOrder(t *testing.T) {
	...
	mustWrite(t, filepath.Join(user, "LGCODE.md"), "USER LEVEL")
	mustWrite(t, filepath.Join(proj, "LGCODE.md"), "PROJECT LEVEL")
	mustWrite(t, filepath.Join(proj, "LGCODE.local.md"), "LOCAL LEVEL")
...
func TestImportResolution(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "LGCODE.md"), "Top line\n@shared.md\nBottom line")
...
func TestImportCycleDoesNotHang(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "LGCODE.md"), "@a.md")
...
func TestImportDiamondAndCycle(t *testing.T) {
	...
	mustWrite(t, filepath.Join(projCycle, "LGCODE.md"), "@cycle1.md")
