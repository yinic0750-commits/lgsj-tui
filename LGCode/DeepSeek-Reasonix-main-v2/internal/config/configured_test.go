...
func TestProviderConfigured(t *testing.T) {
	...
	cases := []struct {
		...
		{"key set", ProviderEntry{APIKeyEnv: "LGCODE_TEST_KEY"}, true},
		{"key env empty", ProviderEntry{APIKeyEnv: "LGCODE_TEST_EMPTY"}, false},
		{"key env unset", ProviderEntry{APIKeyEnv: "LGCODE_TEST_MISSING"}, false},
