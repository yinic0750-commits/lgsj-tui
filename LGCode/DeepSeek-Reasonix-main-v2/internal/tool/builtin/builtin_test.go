...
func TestEditFile(t *testing.T) {
	...
	runTool(t, editFile{}, map[string]any{"path": f, "old_string": "world", "new_string": "lgcode"})
	if b, _ := os.ReadFile(f); string(b) != "hello lgcode\n" {
...
func TestMultiEdit(t *testing.T) {
	...
	out := runTool(t, multiEdit{}, map[string]any{
		...
		"edits": []map[string]any{
			...
			{"old_string": "old", "new_string": "lgcode", "replace_all": true},
		},
	})
