...
Thank you for your interest in contributing to LGcode! This guide covers
...
```bash
git clone https://github.com/esengine/DeepSeek-LGcode.git
cd DeepSeek-LGcode
...
| `internal/memory` | LGCODE.md hierarchy + auto-memory |
