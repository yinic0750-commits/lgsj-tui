...
// SetGate installs the per-call permission gate. Used by `lgcode chat` to swap the
...
// `lgcode chat --resume` to load a saved JSONL transcript before the first turn,
