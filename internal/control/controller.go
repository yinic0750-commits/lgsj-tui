...
// headless `lgcode run` path, where the Sink renders to stdout and the caller
...
// out of project lgcode.toml while preserving the CLI AddMCPServer semantics.
...
// LGCODE.md by default) — the write side of "#<note>". Returns the file written.
