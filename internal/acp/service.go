...
// `lgcode acp` command) implements it by reusing setup()'s assembly: a
...
// point the `lgcode acp` command calls.
//
...
// sessionSetConfigOption applies ACP's generic session-level selector. LGcode
