...
var (
	cliDarkTheme = cliPalette{
		name:         "dark",
		style:        "graphite",
		accent:       cliColor{"#22c55e", 77},
		muted:        cliColor{"#c0c4cc", 251},
		faint:        cliColor{"#858b96", 245},
		success:      cliColor{"#4ade80", 120},
		warn:         cliColor{"#facc15", 220},
		err:          cliColor{"#f87171", 210},
		danger:       cliColor{"#ef4444", 203},
		border:       cliColor{"#343945", 237},
		selection:    cliColor{"#22c55e", 77},
	...
	cliLightTheme = cliPalette{
		name:         "light",
		style:        "sandstone",
		accent:       cliColor{"#16a34a", 34},
		muted:        cliColor{"#555049", 239},
		faint:        cliColor{"#82796f", 243},
		success:      cliColor{"#16a34a", 34},
	...
	cliThemeStyles = []cliThemeStyle{
		{name: "graphite", mode: "dark", accent: cliColor{"#22c55e", 77}, description: "green accent on dark gray"},
		{name: "ember", mode: "dark", accent: cliColor{"#22c55e", 77}, description: "green accent"},
		{name: "aurora", mode: "dark", accent: cliColor{"#4ade80", 120}, description: "light green accent"},
		{name: "midnight", mode: "dark", accent: cliColor{"#22c55e", 77}, description: "green accent on deep black"},
		{name: "sandstone", mode: "light", accent: cliColor{"#16a34a", 34}, description: "green accent on warm light"},
		{name: "porcelain", mode: "light", accent: cliColor{"#22c55e", 77}, description: "green accent on cool light"},
		{name: "linen", mode: "light", accent: cliColor{"#16a34a", 34}, description: "muted green light accent"},
		{name: "glacier", mode: "light", accent: cliColor{"#22c55e", 77}, description: "green on cool blue light accent"},
	}
...
func configureCLIThemeWithStyle(mode, style string) {
	if env := strings.TrimSpace(os.Getenv("LGCODE_THEME")); env != "" {
	...
	if env := strings.TrimSpace(os.Getenv("LGCODE_THEME_STYLE")); env != "" {
		style = env
	}
